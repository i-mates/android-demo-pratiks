...
package in.jigyasacodes.totask.ui.dialog;
...
public class Dialogs {
	...
	public Dialogs(Context ctx/* , View view */) {
		...
		this.ctx = ctx;
		this.onNetIssueADYesClickListener = (OnNetIssueADYesClickListener) this.ctx;
		// this.view = view;
	}
				...
				.setPositiveButton("Yes",
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog, int id) {
								...
								Toast.makeText(
										Dialogs.ctx,
										"Navigating to Smartphone's Data Connection Settings >",
	...
	private View typeFaceApplier(View view, String strFontName) {

		Typeface tf = Typeface.createFromAsset(this.ctx.getAssets(), strFontName);
	...
	public interface OnNetIssueADYesClickListener {
		...
		public void onNetIssueADYesClickListener(
